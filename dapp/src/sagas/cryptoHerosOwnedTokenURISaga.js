...
export function* getCryptoHerosTokenOwnedTokenURIResultSaga({networkId, tokenId}) {
  try {
    ...
    yield put({ type: types.CRYPTOHEROS_TOKEN_TOKEN_URI_SUCCESS, result: cryptoHerosTokenOwnedTokenURIResult });
  } catch (err) {
